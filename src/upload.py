...
def run_tiktok_upload(
    file: str = "output.mp4",
    title: str = "Top 10 Trending",
    description: str = "The top 10 most liked videos today",
    keywords: str = "tiktok, trending",
    privacy_status: str = "public",
):

    argparser.add_argument("--file", default="output.mp4", help="Video file to upload")
...
def get_authenticated_service(args):
    ...
    return build(
        ...
        YOUTUBE_API_VERSION,
        developerKey=my_secrets.developer_key,
